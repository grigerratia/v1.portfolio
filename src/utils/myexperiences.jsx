...
//!Las imágenes en este archivo deben tener una relación de 200 * 200 pixeles
...
const EXPERIENCES = [
	{
		...
		texto: [
			`Desarrollar para`,
			<Anchor text='Cesticom' anchor='https://cesticom.com/' />,
	...
	},
	{
		...
		texto: [
			...
			<Anchor text='Cesar Luis' anchor='https://cesarluis.com/' />,
